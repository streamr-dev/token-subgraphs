...
export class Voting__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class Voting extends ethereum.SmartContract {
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): Voting__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<Voting__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<Voting__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<Voting__checkpointsResultValue0Struct>(value[0].toTuple())
    );
  }
